This respository provides code accompanying the paper  ``Off-policy evaluation beyond overlap: partial identification through smoothness." The files and folders it contains are:
